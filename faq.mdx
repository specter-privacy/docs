...
<AccordionGroup>
  ...
  <Accordion title="Can I try it without installing anything?">
    Yes! Just click **[Launch app](https://specterpq.com/)** and explore the full flow in your browser. No local setup, no downloads, no wallet required for testing.
  </Accordion>
</AccordionGroup>
...
<AccordionGroup>
  <Accordion title="Can I explore SPECTER without any local setup?">
    Yes! Use the **[Launch app](https://specterpq.com/)** button and follow the [Explore product](/explore/frontend-experience) guide. The hosted frontend connects to the live backend — no installation required.
  </Accordion>
