...
<AccordionGroup>
  ...
  <Accordion title="What does 'post-quantum' mean?">
    Current encryption (like the kind used in Bitcoin and Ethereum) could be broken by future quantum computers. SPECTER uses **ML-KEM-768** (formerly called Kyber), a new encryption standard specifically designed to resist quantum attacks. This means your privacy stays safe even in a post-quantum world.
  </Accordion>
