...
<Frame>
  ![Generic wallet vs SPECTER](/images/specter/generic-wallet-vs-specter.png)
</Frame>
...
<Frame>
  ![Post-quantum cryptography](/images/specter/post-quantum-crypto.png)
</Frame>
...
<Reveal>
<CardGroup cols={2}>
  <Card title="How SPECTER solves this" icon="shield-lock" href="/why-specter/how-specter-works">
