...
<Steps>
  <Step title="Choose a scoped problem" icon="tools">
    Pick an existing GitHub issue or open a new one with a clear acceptance target.
  </Step>
  <Step title="Set up the workspace" icon="tools">
