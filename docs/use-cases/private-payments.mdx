...
description: "How SPECTER enables private receiving on Ethereum, Arbitrum, Monad, and Sui"
---
...
The same meta-address produces valid stealth addresses for both the EVM chains and Sui. The API returns an EVM address, which works on Ethereum, Arbitrum, and Monad, and a separate Sui address:
...
Ethereum, Arbitrum, Monad, and Sui are supported today (testnet-first). Base and Optimism are on the roadmap.
