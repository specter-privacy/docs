...
<Frame>
  ![Security boundaries](/images/specter/security-boundaries.png)
</Frame>
...
| Stealth address derivation | SHAKE-256 tweak + secp256k1 + keccak256 | Post-quantum safe |
...
<Frame>
  ![Compatibility gap](/images/specter/compatibility-gap.png)
</Frame>
