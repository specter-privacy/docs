...
flowchart LR
    ...
    style PQ fill:#7c3aed,color:#fff
...
<Frame caption="The viewing path is post-quantum protected by ML-KEM-768. Classical execution stays compatible with today's chains.">
  ![Diagram of where ML-KEM-768 protects the SPECTER viewing path against future quantum decryption](/images/specter/specter-ml-kem-full.png)
</Frame>
...
<CardGroup cols={2}>
  ...
  <Card title="PQ crypto explainer" icon="circuit-resistor" href="/deep-dive/post-quantum-explainer">
