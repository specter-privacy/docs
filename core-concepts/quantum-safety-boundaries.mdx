...
```mermaid
flowchart LR
    A["Meta-address"] --> B["ML-KEM encapsulation"]
    B --> C["Stealth destination discovered privately"]
    C --> D["Funds sit at one-time address"]
    D --> E["Spend with Ethereum-compatible key"]
