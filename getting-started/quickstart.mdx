...
<CardGroup cols={2}>
  <Card title="Launch app" icon="rocket" href="https://specter-stealth.vercel.app/">
    Try the same flow in the UI while running CLI/curl locally.
  </Card>
  <Card title="API map" icon="sitemap" href="/api/introduction">
    Keep route docs open while executing commands.
  </Card>
</CardGroup>
...
<details>
<summary><strong>UX tip for teams</strong></summary>

Run this quickstart as a team checklist during onboarding and release validation.

- One person runs sender steps.
- One person runs recipient scan.
- Compare output addresses together.
