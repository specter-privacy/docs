...
<CardGroup cols={2}>
  ...
  <Card title="I Need Use Cases + Yellow" icon="sitemap" href="/guides/use-cases-and-yellow-integration">
    Start from the live Yellow integration and current roadmap boundaries.
  </Card>
  <Card title="I Want a Playground" icon="bolt" href="/explore/playground">
    Run copy-paste API flows before full integration work.
  </Card>
</CardGroup>
