...
<Tabs>
  ...
  <Tab title="Frontend-first">
    ...
    **Best for:** Teams building privacy-focused UIs who want a working reference.
    ...
    The frontend source is at `SPECTER-web/` in the repo. Key patterns:
    - Type-safe API client: `lib/api.ts`
    - Key encryption for browser storage: `lib/crypto/`
    - Chain configuration: `lib/blockchain/chainConfig.ts`
    - Wallet integration: `components/features/wallet/`
  </Tab>
